...
print color('bold red'),"] ";
print color("bold white"),"scanner |> enter ur site and it will scan it\n";
print color('bold red'),"[";
print color('bold green'),"2";
print color('bold red'),"] ";
print color("bold white"),"COMING SOON |> IDK\n";
print color("bold red")," \n\nkali->";
...
if($number eq '2')
{
print "HEY I SAID COMING SOON WAIT FOR AN UPDATE!\n";
exit
}
